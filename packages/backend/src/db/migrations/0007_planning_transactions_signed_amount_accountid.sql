...
DROP CONSTRAINT "PlanningTransactions_accounts_ck"; -- > statement-breakpoint
ALTER TABLE "PlanningTransactions"
DROP CONSTRAINT "PlanningTransactions_fromAccountId_PlanningAccounts_accountId_fk";
...
ALTER TABLE "PlanningTransactions"
ADD CONSTRAINT "PlanningTransactions_inflow_ck"
  CHECK (
...
ALTER TABLE "PlanningTransactions"
ADD CONSTRAINT "PlanningTransactions_accounts_ck"
  CHECK (
    "PlanningTransactions"."toAccountId" IS NULL
